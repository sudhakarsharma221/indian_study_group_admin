package com.indiastudygroupadmin.edit_profile.ui
...
class EditProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val street = intent.getStringExtra("address")
        val pincode = intent.getStringExtra("pincode")
        val state1 = intent.getStringExtra("state")
        val district1 = intent.getStringExtra("district")
        val profile = intent.getStringExtra("profile")


        binding.nameEt.setText(name)
        binding.addressEt.setText(street)
        binding.pincodeEt.setText(pincode)
        binding.tvState.text = state1
        binding.tvCity.text = district1
        Glide.with(this).load(profile).placeholder(R.drawable.profile).error(R.drawable.profile)
